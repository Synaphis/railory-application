    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href={current}
            download={`railory-tryon-${idx + 1}.png`}
            target="_blank"
    ...
    <div>
      <div className="px-8 py-6">
        ...
        <p className="text-sm text-muted-slate mb-8">
          Your virtual try-on gallery. Download or share your favourites.
        </p>
          ...
          {items.map((item) =>
            item.allImages.map((imgUrl, imgIdx) => (
              <button
                ...
                className="group relative aspect-[3/4] bg-stone overflow-hidden border border-hairline hover:border-ink transition-colors"
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={imgUrl}
